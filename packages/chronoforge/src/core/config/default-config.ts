import type { ChronoConfig } from "../types";
...
export function reconfigureConfig(config: ChronoConfig): ValidatedConfig {
  const isIChronoAdapter = (val: any) =>
