...
export class SchedulerMetrics {
	...
	private getOrCreate(name: string, type: "cron" | "schedule"): ScheduleAccumulator {
	...
	private handleFireStart = (scheduleName: string, _runId: string, type: "cron" | "schedule"): void => {
